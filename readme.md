...
2. 1. For eclipse follow [this instruction](https://projectlombok.org/download.html)
2. 2. For intellij idea go to settings -> plugins -> browse repositories for "lombok" -> install, restart. Then go to "Annotation Processors" and set "Enable annotation processing"
