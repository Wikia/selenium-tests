...
//	@Test(groups = {"SignUp_field_validation_TC001"})
	...
	public void SignUp_field_validation_TC002()
	{
        ...
        private String userNameNotExisting;
        private String passwordNotExisting;
        
        @Test(groups = {"SignUp_field_validation_TC003"})
        public void SignUp_field_validation_TC003() {
                SignUpPageObject signUpPage = new SignUpPageObject(driver);
                signUpPage.openSignUpPage();
                userNameNotExisting = signUpPage.getTimeStamp();
                signUpPage.typeInUserName(userNameNotExisting);
                userNameEmail = Properties.emailQaart4;
                signUpPage.typeInEmail(userNameEmail);
                passwordNotExisting = signUpPage.getTimeStamp();
