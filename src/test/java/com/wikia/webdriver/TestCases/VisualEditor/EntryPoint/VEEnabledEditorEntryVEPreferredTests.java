...
//		wikiURL = urlBuilder.getUrlForWiki(URLsContent.veEnabledTestMainPage);
	...
	@Test(
		groups = {"VEEnabledEditorEntryVEPreferred", "VEEnabledEditorEntryVEPreferredTests_009"}
	)
	public void VEEnabledEditorEntryVEPreferredTests_009_MediawikiNamespace() {
	...
	@Test(
		groups = {"VEEnabledEditorEntryVEPreferred", "VEEnabledEditorEntryVEPreferredTests_010"}
	)
	public void VEEnabledEditorEntryVEPreferredTests_010_actionEdit() {
