...
public class SpecialPagesDataProvider {
  ...
  public static final Object[][] getSpecialPagesForAnons() {
    return new Object[][] { {"Special:BrokenRedirects", "Broken redirects"},
        {"Special:DeadendPages", "Dead-end pages"},
        {"Special:DoubleRedirects", "Double redirects"}, {"Special:LongPages", "Long pages"},
        {"Special:AncientPages", "Oldest pages"}, {"Special:LonelyPages", "Orphaned pages"},
        {"Special:FewestRevisions", "Pages with the fewest revisions"},
        {"Special:WithoutInterwiki", "Pages without language links"},
        {"Special:ProtectedPages", "Protected pages"}, {"Special:ShortPages", "Short pages"},
        ...
        {"Special:UnusedFiles", "Unused photos"}, {"Special:UnusedTemplates", "Unused templates"},
        {"Special:WantedCategories", "Wanted categories"}, {"Special:WantedPages", "Wanted pages"},
        {"Special:WantedFiles", "Wanted photos"}, {"Special:WantedTemplates", "Wanted templates"},
        {"Special:AllPages", "All pages"}, {"Special:PrefixIndex", "All pages with prefix"},
        {"Special:Categories", "Categories list"}, {"Special:CategoryTree", "Category tree"},
