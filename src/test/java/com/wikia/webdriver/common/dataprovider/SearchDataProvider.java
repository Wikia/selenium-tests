...
public class SearchDataProvider {
  ...
  public static final Object[][] getOnWikiHostsTermsAndMatchUrls() {
    return new Object[][]{{"http://starwars.wikia.com/", "darth vader",
  ...
  public static final Object[][] getExpectedWikiResults() {
    return new Object[][]{{"Marvel Database"}, {"Marvel Movies"}, {"Marvel: War of Heroes Wiki"},
                          {"Marvel: Avengers Alliance Wiki"}, {"Marvel Fanon"},
                          {"Marvel-Microheroes Wiki"}, {"Marvel Heroes Wiki"},
                          {"Marvel Cinematic Universe Wiki"}, {"Comic Crossroads"},
