...
public class AdsDataProvider {
  ...
  public static final String[] OASIS_SLOTS_TO_SMOKE_TEST = {AdsContent.TOP_LB, AdsContent.MEDREC,
      AdsContent.LEFT_SKYSCRAPPER_2, AdsContent.LEFT_SKYSCRAPPER_3, AdsContent.PREFOOTER_LEFT,
  ...
  public static Object[][] mainWikiPages() {
    return new Object[][] { {"runescape", "RuneScape_Wiki"}, {"yugioh", "Main_Page"},
        {"naruto", "Narutopedia"}, {"leagueoflegends", "League_of_Legends_Wiki"},
        {"es.drama", "Portada"}, {"de.memory-alpha", "Hauptseite"},
  ...
  public static Object[][] popularSites() {
    return new Object[][] {
        ...
        {"gameofthrones", "Daenerys_Targaryen"}, {"elderscrolls", "Console_Commands_(Skyrim"},
        // intentionally without ) sign - there is redirect on page
        {"naruto", "Naruto_Uzumaki"}, {"clashofclans", "Air_Sweeper"}, {"leagueoflegends", "Ekko"},
        {"lego", "LEGO"}};
  }
  ...
  public static Object[][] noAdsForUsers() {
    return new Object[][] {
        ...
        {"it.creepypasta", "Categoria:Creepypasta"}, {"wikia", "Wikia"},
        {"wikia", "Video_Games/Lizzunchbox"}, {"monsterhunter", "MH3U:_Monsters"},
        {"monsterhunter", "Portal:MH3U"}, {"adtest-pluto", "VeryLongPage"},
  ...
  public static Object[][] noAdsForSony() {
    return new Object[][] {
        ...
        // Main pages
        {"runescape", "RuneScape_Wiki"}, {"yugioh", "Main_Page"}, {"naruto", "Narutopedia"},
        {"leagueoflegends", "League_of_Legends_Wiki"}, {"es.drama", "Portada"},
        {"de.memory-alpha", "Hauptseite"}, {"de.marvel-filme", "Marvel-Filme"},};
  }

  @DataProvider
  public static Object[][] pagesWithAIC() {
    return new Object[][] { {"zh.pad", "%E7%9A%87%E3%81%9F%E3%82%8B%E6%A9%9F%E6%A2%B0%E9%BE%8D"},
        ...
        {"ru.elderscrolls", "%D0%9A%D0%B2%D0%B5%D1%81%D1%82%D1%8B_%28Skyrim%29"},
        {"monsterhunter", "MH3U:_Monsters"}, {"elderscrolls", "Skyrim"}, {"dragonvale", "Eggs"},
        {"callofduty", "Mob_of_the_Dead"}, {"yugioh", "Lord_of_the_Tachyon_Galaxy"},
  ...
  public static Object[][] specialPages() {
    return new Object[][] {
        ...
        {"adtest", "Special:NewFiles", "126608052", "wka.life/_adtest//special", "TOP_LEADERBOARD",
            "PREFOOTER_LEFT_BOXAD", new Dimension(1292, 1000)},};
  }
  ...
  public static Object[][] skin() {
    return new Object[][] {
        {"adtest-pluto", "Skin", new Dimension(1200, 1000),
            "src/test/resources/adsResources/no_wikia_skin_left.png",
            "src/test/resources/adsResources/no_wikia_skin_right.png", null, null},
        {"adtest-pluto", "Skin", new Dimension(1600, 900),
            "src/test/resources/adsResources/wikia_skin_left.png",
            "src/test/resources/adsResources/wikia_skin_right.png", "AAAAAA", "FFFFFF"},
        {"adtest-pluto", "Skin", new Dimension(1920, 1080),
            "src/test/resources/adsResources/wikia_skin_left.png",
            "src/test/resources/adsResources/wikia_skin_right.png", "AAAAAA", "FFFFFF"},
        {"adtest-pluto", "Skin", new Dimension(2400, 1080),
            "src/test/resources/adsResources/wikia_skin_left.png",
            "src/test/resources/adsResources/wikia_skin_right.png", "AAAAAA", "FFFFFF"},
        {"adtest", "Skin", new Dimension(1600, 900),
            "src/test/resources/adsResources/wikia_skin_left.png",
            "src/test/resources/adsResources/wikia_skin_right.png", "AAAAAA", "FFFFFF"},
        {"adtest", "Skin", new Dimension(1920, 1080),
            "src/test/resources/adsResources/wikia_skin_left.png",
            "src/test/resources/adsResources/wikia_skin_right.png", "AAAAAA", "FFFFFF"},
        {"adtest", "Skin", new Dimension(2400, 1080),
            "src/test/resources/adsResources/wikia_skin_left.png",
            "src/test/resources/adsResources/wikia_skin_right.png", "AAAAAA", "FFFFFF"},
        {"adtest", "Skin/NoMiddleColor", new Dimension(1920, 1080),
            "src/test/resources/adsResources/wikia_skin_left.png",
            "src/test/resources/adsResources/wikia_skin_right.png", "AAAAAA", ""}};
  }
  ...
  public static Object[][] adFreeWikis() {
    return new Object[][] { {"api", "Wikia_API_Wiki"}, {"sfhomeless", "Glide_Memorial_Church"},
        {"geekfeminism", "Dickwolves"}, {"suicideprevention", "USA"}};
  }

  @DataProvider
  public static Object[][] getWikisWithStandardHVC() {
    return new Object[][] { {"adtest"}, {"de.icarly"}, {"en.memory-alpha"}};
  }

  @DataProvider
  public static Object[][] adDriverForcedStatusSuccess() {
    return new Object[][] {{"adtest", "AdDriver2ForceStatus/Success",
  ...
  public static Object[][] spotlights() {
    return new Object[][] {{"glee", "Rachel"}};
  }

  @DataProvider
  public static Object[][] amazonSites() {
    return new Object[][] {{"adtest", "SyntheticTests/Amazon"},};
  }
  ...
  public static Object[][] evolveHopTestPage() {
    return new Object[][] {{"adtest", "SyntheticTests/Evolve/Hop", "TOP_LEADERBOARD", "RemnantGpt"}};
  }

  @DataProvider
  public static Object[][] providersChainOasis() {
    return new Object[][] {
        {"adtest", "SyntheticTests/ProvidersChain", "TOP_LEADERBOARD",
            "DirectGpt; RemnantGpt; Liftium", 0},
        {"adtest", "SyntheticTests/ProvidersChain", "TOP_LEADERBOARD",
            "DirectGpt; RemnantGpt; Liftium", 3},
        {"adtest", "SyntheticTests/ProvidersChain", "INVISIBLE_SKIN", "DirectGpt; RemnantGpt", 0}};
  }

  @DataProvider
  public static Object[][] disableGptOasis() {
    return new Object[][] {{"adtest", "SyntheticTests/ProvidersChain",
        "InstantGlobals.wgSitewideDisableGpt=1", "TOP_LEADERBOARD",
        "DirectGpt; RemnantGpt; Liftium", "Liftium"},};
  }

  @DataProvider
  public static Object[][] kruxIntegration() {
    return new Object[][] { {"elderscrolls", "Skyrim"}, {"wowwiki", "Portal:Main"},
        {"zh.pad", "Special:Video"}};
  }

  @DataProvider
  public static Object[][] kruxRealTimeSegment() {
    return new Object[][] {{"adtest", "SyntheticTests/Krux/Page_1", "glee", "Rachel", "o8l9bis26"}};
  }

  @DataProvider
  public static Object[][] kruxSegments() {
    return new Object[][] {
        {"J-RIfJI0", "pqdapsy7l", new Page("vim", "Vim_Tips_Wiki"),
            // Standard segment for visiting adtest before
            "[\"pqdapsy7l\"]", new Page("adtest", "SyntheticTests/Krux/Page_1"),
            // Both standard and real-time segment for adtest
            "[\"o8l9bis26\",\"pqdapsy7l\"]",},
        {null, null, new Page("adtest", "SyntheticTests/Krux/Page_1"), "[\"o8l9bis26\"]",
            new Page("glee", "Glee_TV_Show_Wiki"),
            // No o8l9bis26 (real time segment for adtest, they don't traverse through wikis)
            "[]",}, {null, null, new Page("vim", "Vim_Tips_Wiki"),
  ...
  public static Object[][] delayBtf() {
    return new Object[][] { {"adtest", "SyntheticTests/ATF", 20, false},
        {"adtest-pluto", "SyntheticTests/ATF", 20, true},};
  }

  @DataProvider
  public static Object[][] disableBtf() {
    return new Object[][] { {"adtest", "SyntheticTests/ATF_DISABLE_BTF", false},
        {"adtest-pluto", "SyntheticTests/ATF_DISABLE_BTF", true},};
  }

  @DataProvider
  public static Object[][] testPad() {
    return new Object[][] { {"adtest-pad", "Adtest-pad_Wikia", 250},
        {"adtest-pad", "Article_1", 480}, {"adtest-pad", "Article_2", 480}};
  }

  @DataProvider
  public static Object[][] interstitialOasis() {
    return new Object[][] {
        {"adtest", "SyntheticTests/Interstitial", new Dimension(1920, 1080),
            new Dimension(600, 590), true},
        {"adtest", "SyntheticTests/Interstitial/NotScalable", new Dimension(1920, 1080),
            new Dimension(300, 343), false},
        {"adtest", "SyntheticTests/Interstitial", new Dimension(800, 800), new Dimension(569, 564),
            true},
        {"adtest", "SyntheticTests/Interstitial/NotScalable", new Dimension(800, 800),
            new Dimension(300, 343), false},};
  }
  ...
  public static Object[][] interstitialMercury() {
    return new Object[][] {
        {"adtest", "SyntheticTests/Interstitial", new Dimension(600, 800), new Dimension(590, 491),
            true},
        {"adtest", "SyntheticTests/Interstitial/NotScalable", new Dimension(600, 800),
            new Dimension(300, 258), false},
        {"adtest", "SyntheticTests/Interstitial", new Dimension(800, 500), new Dimension(405, 338),
            true},
        {"adtest", "SyntheticTests/Interstitial/NotScalable", new Dimension(800, 500),
            new Dimension(300, 258), false},};
  }
  ...
  public static Object[][] adsSynthetic() {
    return new Object[][] {{
        ...
        ImmutableMap.<String, Object>builder().put("slotName", "MOBILE_TOP_LEADERBOARD")
            .put("slotSize", new Dimension(320, 100)).put("lineItemId", 136987812)
            .put("src", "mobile").build(), new Dimension(360, 567),
