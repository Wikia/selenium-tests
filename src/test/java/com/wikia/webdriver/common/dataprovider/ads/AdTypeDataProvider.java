...
public class AdTypeDataProvider {
  ...
  public static final Object[][] asyncSuccessWithAd() {
    return new Object[][] {{"adtest", "SyntheticTests/Async/Success", "wka.life/_adtest//article",
        "MOBILE_PREFOOTER",
  ...
  public static final Object[][] asyncHopNoAd() {
    return new Object[][] {{"adtest", "SyntheticTests/Async/Hop", "wka.life/_adtest//article",
  ...
  public static final Object[][] asyncSuccessNoAd() {
    return new Object[][] {{"adtest", "SyntheticTests/Async/Success/NoAd",
        "wka.life/_adtest//article", "MOBILE_PREFOOTER"
  ...
  public static final Object[][] asyncHopWithAd() {
    return new Object[][] {{"adtest", "SyntheticTests/Async/Hop/WithAd",
        "wka.life/_adtest//article", "MOBILE_PREFOOTER"
  ...
  public static final Object[][] asyncHopWithSpecialProvider() {
    return new Object[][] {{"adtest", "SyntheticTests/Async/Hop/WithAd",
        "wka.life/_adtest//article", "MOBILE_TOP_LEADERBOARD"
  ...
  public static final Object[][] forcedSuccessNoAd() {
    return new Object[][] {{"adtest", "SyntheticTests/AdType/ForcedSuccess",
        "wka.life/_adtest//article", "MOBILE_PREFOOTER"
  ...
  public static final Object[][] inspectIframeImg() {
    return new Object[][] {{"adtest", "SyntheticTests/AdType/InspectIframe",
        "wka.life/_adtest//article", "MOBILE_PREFOOTER",
        "googlesyndication.com/pagead/imgad?id=CICAgKCNj62dEhCsAhj6ASgBMgjBw3U0lR5Thg"
  ...
  public static final Object[][] collapse() {
    return new Object[][] {{"adtest", "SyntheticTests/AdType/Collapse",
        "wka.life/_adtest//article", "TOP_RIGHT_BOXAD"
