...
public class ArticleDataProvider {
  ...
  public static final Object[][] getArticleName() {
    return new Object[][]{{"QAarticle"},
                          ...
                          {"QA/article"}, {"QA_article"}, {"123123123123"}};
  }

  @DataProvider
  public static final Object[][] articleTitles() {
    return new Object[][]{
        {"QAarticleĄŻŁ"}, {"QAarticle國歷史"}, {"QAarticle/"},
                          {"QAarticle QAarticle"}};
  }

  @DataProvider
  public static final Object[][] getPageNames() {
    return new Object[][]{{"Muppets"}, {"Gta"}, {"Star_trek"}, {"Harry_potter"}, {"Star_wars"}};
  }
}
