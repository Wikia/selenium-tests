...
public class UserAgentsRegistry {
  ...
  public UserAgentsRegistry() {
    ...
    userAgentRegistry.put("sony_tvs", "Mozilla/5.0(X11; sony_tvs; Linux x86_64; rv:24.0)"
        + "Gecko/20100101 Firefox/24.0");
    userAgentRegistry.put("iPhone", "Mozilla/6.0 (iPhone; CPU iPhone OS 8_0 like Mac OS X) "
        + "AppleWebKit/536.26 (KHTML, like Gecko) " + "Version/8.0 Mobile/10A5376e Safari/8536.25");
    userAgentRegistry.put("iPhone+Mercury",
        "Mozilla/6.0 (iPhone; CPU iPhone OS 8_0 like Mac OS X) "
            + "AppleWebKit/536.26 (KHTML, like Gecko, WikiaMercury) "
