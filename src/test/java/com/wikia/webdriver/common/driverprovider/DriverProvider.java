...
public class DriverProvider {
	...
	public static DriverProvider getInstance() {
		...
		} else if ("CHROME".equals(Global.BROWSER)) {
			setChromeProperties();
			driver = new EventFiringWebDriver(
				new ChromeDriver(caps)
			).register(listener);
		} else if ("SAFARI".equals(Global.BROWSER)) {
                /*
...
//                }
//            } 
		} else if ("CHROMEMOBILE".equals(Global.BROWSER)) {
			setChromeProperties();
		...
		} else if ("HTMLUNIT".equals(Global.BROWSER)) {
			driver = new EventFiringWebDriver(new HtmlUnitDriver()).register(listener);
		} else if ("GHOST".equals(Global.BROWSER)){
		...
		if (("CHROME".equals(Global.BROWSER) || "CHROMEMOBILE".equals(Global.BROWSER) || "SAFARI".equals(Global.BROWSER))) {
