...
public class EventsGlobalNavigation {
   ...
   * suggestion - search-after-suggest-enter clear suggestion trigger suggestion mouse click on
   * suggestion - search-suggest click search after suggestion - search-after-suggest-button clear
   * suggestion search for query click search button - search-button click enter button -
   * search-enter
   */
  ...
  public static JsonObject searchSuggestionClick = Json
      ...
      .add(
          "0",
          Json.createObjectBuilder().add(EventParameter.ACTION.getEventParameter(), "click")
