...
public class PalantirContent {
  ...
  public static final String PONTOMSG_MAP_OUTOFBOUNDARIES =
      "Map location must be inside map boundaries";
  public static final String PONTOMSG_WRONG_PARAM = "Wrong parameters types";
  public static final String PONTOMSG_REMOVEPLAYER =
      "Player location removed from map successfully";
  ...
  public static final String PONTO_SETPLAYER = "var callback = arguments[arguments.length - 1];"
      ...
      + "	callback," + "	function (response) {}, " + "	true" + ");";
  public static final String PONTO_REMOVEPLAYER = "var callback = arguments[arguments.length - 1];"
      + "Ponto.invoke(" + "	'im.pontoCommunicationAPI', " + "	'removePlayerLocation', " + "	null, "
      + "	callback," + "	function (response) {}, " + "	true" + ");";
  public static final String PONTO_UPDATEPOSITION =
      "var callback = arguments[arguments.length - 1];" + "Ponto.invoke("
          + "	'im.pontoCommunicationAPI', " + "	'updateMapPosition',"
          + "	{lat: arguments[0], lng: arguments[1], zoom:arguments[2]}," + "	callback,"
