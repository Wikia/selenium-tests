...
public class URLsContent {
	...
	public static final String SPECIAL_EDITING_PREFERENCES = "wiki/Special:Preferences#mw-prefsection-editing";
	...
	public static final String MONETIZATION_GEOTEST_WIKI = "th.sktest123";
