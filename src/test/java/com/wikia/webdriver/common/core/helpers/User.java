...
public enum User {
  ...
  INVALIDATED_TOKEN_USER_1("ci.user.regular7.username", "ci.user.regular7.password"),
  LOGIN_USER("ci.user.regular8.username", "ci.user.regular8.password"),
  USER_9("ci.user.regular9.username", "ci.user.regular9.password"),
  INVALIDATED_TOKEN_USER_2("ci.user.regular10.username", "ci.user.regular10.password"),
