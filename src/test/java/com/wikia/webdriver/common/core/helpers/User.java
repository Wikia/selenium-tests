...
public enum User {
  ...
  INVALIDATED_TOKEN_USER_1("ci.user.regular7.username", "ci.user.regular7.password", "ci.user.regular7.user_id"),
  LOGIN_USER("ci.user.regular8.username", "ci.user.regular8.password"),
  USER_9("ci.user.regular9.username", "ci.user.regular9.password"),
  INVALIDATED_TOKEN_USER_2("ci.user.regular10.username", "ci.user.regular10.password", "ci.user.regular10.user_id"),
  ...
  FORCED_LOGIN_USER("ci.user.regular13.username", "ci.user.regular13.password"),
  USER_GERMAN("ci.user.language5.username", "ci.user.language5.password"),
  USER_JAPAN("ci.user.language11.username", "ci.user.language11.password"),
  ...
  LOGIN_STAFF("ci.user.wikiastaff2.username", "ci.user.wikiastaff2.password"),
  ...
  WIKIACTIVITY_USER("ci.user.wikiactivity.username", "ci.user.wikiactivity.password", "ci.user.wikiactivity.user_id"),
