...
public class AdsAmazonObject extends AdsBaseObject {
  ...
  public static final String[] DESKTOP_SLOTS = {AdsContent.TOP_BOXAD};
  ...
  private static final String
      QS_TURN_ON_A9_VIDEO
      = "InstantGlobals.wgAdDriverA9VideoBidderCountries=[XX]";
  private static final String QS_TURN_ON_A9_VIDEO_DEBUG = "amzn_debug_mode=1";
  public static final String[] A9_VIDEO_DEBUG_MODE = {QS_TURN_ON_A9, QS_TURN_ON_A9_VIDEO,
