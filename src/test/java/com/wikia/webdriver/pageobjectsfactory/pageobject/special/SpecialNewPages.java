 ...
 *
 * This is a special page that lists recently created pages in reverse order of creation, with
 * creation date and time, current size, user who created the page, and first edit summary. It also
 * provides links to patrol these new pages when that feature is enabled.
 */
