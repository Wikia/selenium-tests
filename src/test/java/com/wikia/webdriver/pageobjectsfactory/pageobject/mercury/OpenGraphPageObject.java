...
public class OpenGraphPageObject extends MobileBasePageObject {
	...
	public void verifyOgTitleMainPage() {
		...
		PageObjectLogging.log("verifyOgTitleMainPage", "og:title meta tag on main wiki page was set correctly", true);
	}
	...
	public void verifyOgSiteNameExists() {
		...
		PageObjectLogging.log("verifyOgSiteNameExists", "og:site_name was in DOM" + ogSiteName.getAttribute("content"), true);
	}
	...
	public void verifyOgDescriptionTagWasChanged(String descriptionOne, String descriptionTwo) {
		...
		PageObjectLogging.log("verifyOgDescriptionTagWasChanged", "og:description tag was changed after redirection to article", true);
	}

	public void verifyOgUrlTag() {
		Assertion.assertTrue(ogUrl.getAttribute("content").equals(canonicalUrl.getAttribute("href")));
		PageObjectLogging.log("verifyUrlTag", "og:url tag was set and was the same like canonical url", true);
	}
