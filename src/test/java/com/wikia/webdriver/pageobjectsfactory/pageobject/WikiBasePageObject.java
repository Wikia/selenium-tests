...
public class WikiBasePageObject extends BasePageObject {
  ...
  private static final String LOGGED_IN_USER_SELECTOR_MERCURY =
      ".wds-global-navigation__modal-control-user .wds-avatar img[title=%userName%], .wds-global-navigation__modal-control-user .wds-avatar__inner-border[title=%userName%]";
