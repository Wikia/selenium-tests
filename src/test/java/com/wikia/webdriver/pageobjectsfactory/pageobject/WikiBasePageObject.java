...
public class WikiBasePageObject extends BasePageObject {
  ...
  private static final String LOGGED_IN_USER_SELECTOR_MERCURY =
      ".wds-global-navigation__modal-control-user div.wds-avatar[title=%userName%], .wds-global-navigation__modal-control-user div.wds-avatar[title=%userName%],"
      + ".wds-global-navigation__modal-control-user div.wds-avatar img[alt=%userName%], .wds-global-navigation__modal-control-user div.wds-avatar svg[alt=%userName%]";
