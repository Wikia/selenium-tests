...
public class VideoAd {
  ...
  private static final String VAST_XML =
      "<?xml version=\"1.0\" encoding=\"UTF-8\"?><VAST xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance"
  ...
  private String parseDuration() {
    ...
    int hours = (int) Math.floor(duration / 3600), minutes = (int) Math.floor(duration / 60 % 60),
        seconds
