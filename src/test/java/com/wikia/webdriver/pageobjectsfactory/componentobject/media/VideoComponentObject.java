...
public class VideoComponentObject extends WikiBasePageObject {
  ...
  public void verifyVideoOoyalaEmbed() {
    ...
    wait.forElementVisible(container.findElement(By.cssSelector(".video-media .innerWrapper")));
  ...
  public void verifyVideoObjectVisible() {
    wait.forElementVisible(videoEmbed.findElement(By.cssSelector(".video-media .innerWrapper")));
