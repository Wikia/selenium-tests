...
public class VisualEditorHyperLinkDialog extends VisualEditorDialog {
  ...
  private By linkCategoryBy = By.cssSelector(
      ".oo-ui-menuSectionOptionWidget .oo-ui-labelElement-label");
  ...
  private void indexLinkCategories() {
    waitForElementNotVisibleByElement(inputPending);
    List<WebElement> linkCategories = driver.findElement(linkResultMenuBy)
        .findElements(linkCategoryBy);
  ...
  public void verifyNewPageIsTop() {
    indexLinkCategories();
    Assertion.assertNumber(pageCategoryIndex[NEW_PAGE_INDEX],
                           0,
  ...
  public void verifyMatchingPageIsTop() {
    indexLinkCategories();
    Assertion.assertNumber(pageCategoryIndex[MATCHING_PAGE_INDEX],
                           0,
  ...
  public void verifyExternalLinkIsTop() {
    indexLinkCategories();
    Assertion.assertNumber(pageCategoryIndex[EXTERNAL_LINK_INDEX],
                           0,
