...
public class ShareToolbarComponentObject extends BasePageObject {
  ...
  public void verifyTwitterIframeVisibility() {
    ...
    PageObjectLogging.log("verifyTwitterIframeVisibility",
                          "Verify that the Twitter Iframe Is Present", true);
  }
  ...
  public void verifyEmailButtonVisibility() {
    ...
    PageObjectLogging.log("verifyEmailButtonVisibility",
                          "Verify that the Email Button Is Present", true);
  }
  ...
  public void verifyTwitterModalURL() {
    ...
    PageObjectLogging.log("verifyTwitterModalURL",
                          "Verify that the Twitter Modal URL is correct", true);
  }
  ...
  public void verifyEmailModalElements() {
    ...
    PageObjectLogging.log("verifyEmailModalElements",
                          "Verify that the Email Modal elements are present", true);
  }
}
