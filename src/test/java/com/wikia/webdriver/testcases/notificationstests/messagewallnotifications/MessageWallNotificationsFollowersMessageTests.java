 ...
 *         <p/>
 *         1. User 5 is following user 6 message wall 2. User 6 is writig a message on his own
 *         message wall, 3. User 5 is notified about the message
 */
public class MessageWallNotificationsFollowersMessageTests extends NewTestTemplate {
  ...
  @Test(groups = {"MessageWallNotificationsFollowersMessageTests_002",
      "MessageWallNotificationsFollowersMessageTests"},
  ...
  @Test(groups = {"MessageWallNotificationsFollowersMessageTests_003",
      "MessageWallNotificationsFollowersMessageTests"},
