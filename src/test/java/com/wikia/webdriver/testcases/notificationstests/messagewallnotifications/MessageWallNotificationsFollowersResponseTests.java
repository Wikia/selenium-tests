 ...
 *         <p/>
 *         1. User 5 is unfollowing user 6 message wall, 2. User 6 is writing message on his own
 *         message wall, 3. User 5 is following user 6 message wall, 4. User 6 is replying to his
 *         message on his own message wall, 5. User 5 is notified about user 6 reply
 */
public class MessageWallNotificationsFollowersResponseTests extends NewTestTemplate {
  ...
  @Test(groups = {"MessageWallNotificationsFollowersResponseTests_002",
      "MessageWallNotificationsFollowersResponseTests"},
  ...
  @Test(groups = {"MessageWallNotificationsFollowersResponseTests_003",
      "MessageWallNotificationsFollowersResponseTests"},
  ...
  @Test(groups = {"MessageWallNotificationsFollowersResponseTests_004",
      "MessageWallNotificationsFollowersResponseTests"},
