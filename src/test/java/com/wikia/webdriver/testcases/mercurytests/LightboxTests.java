...
public class LightboxTests extends NewTestTemplate {
  ...
  public void MercuryLightboxTests_001_TappingImageOpenLightbox() {
    ...
    LightBoxMercuryComponentObject
        lightbox =
  ...
  public void MercuryLightboxTests_004_ZoomThroughPanninAndDoubleTapping() {
    ...
    lightbox.verifyCurrentImageIsVisible();
    lightbox
        .verifyZoomingByGesture(touchAction, LightBoxMercuryComponentObject.ZOOM_METHOD_GESTURE);
    lightbox.clickCloseButton();
  ...
  public void MercuryLightboxTests_008_MovingImageAfterZooming() {
    ...
    LightBoxMercuryComponentObject
        ...
        article.clickGalleryImage(MercuryContent.MERCURY_GALLERY_IMAGE_INDEX);
    lightbox.verifyCurrentImageIsVisible();
    lightbox.verifyMovingImageAfterZoomingToDirection(touchAction,
    ...
    lightbox.verifyCurrentImageIsVisible();
    lightbox.verifyMovingImageAfterZoomingToDirection(touchAction,
                                                      LightBoxMercuryComponentObject.DIRECTION_DOWN);
  }
}
