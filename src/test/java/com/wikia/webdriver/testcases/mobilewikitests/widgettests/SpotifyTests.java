...
public class SpotifyTests extends NewTestTemplate {
  ...
  private static final String
      ...
      = "SpotifyMercury/MultipleWidgets";
  private static final String
      SPOTIFY_INCORRECT_WIDGET_ARTICLE_NAME
      = "SpotifyMercury/IncorrectWidget";
  ...
  public void MercurySpotifyWidgetTest_001_isLoadedOnFirstVisitDirectlyFromUrl() {
    WidgetPageObject widget = new SpotifyWidgetPageObject().create(SPOTIFY_ONE_WIDGET_ARTICLE_NAME);
  ...
  public void MercurySpotifyWidgetTest_004_areLoadedOnFirstVisitDirectlyFromUrl() {
    WidgetPageObject widget = new SpotifyWidgetPageObject().createMultiple(
        SPOTIFY_MULTIPLE_WIDGETS_ARTICLE_NAME);
  ...
  public void MercurySpotifyWidgetTest_005_isErrorPresent() {
    WidgetPageObject widget = new SpotifyWidgetPageObject().createIncorrect(
        SPOTIFY_INCORRECT_WIDGET_ARTICLE_NAME);
