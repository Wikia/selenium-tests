...
public class TwitterTests extends NewTestTemplate {
  ...
  private static final String
      ...
      = "TwitterMercury/MultipleWidgets";
  private static final String
      TWITTER_INCORRECT_WIDGET_ARTICLE_NAME
      = "TwitterMercury/IncorrectWidget";
  ...
  public void MercuryTwitterWidgetTest_001_isLoadedOnFirstVisitDirectlyFromUrl() {
    WidgetPageObject widget = new TwitterWidgetPageObject().create(TWITTER_ONE_WIDGET_ARTICLE_NAME);
  ...
  public void MercuryTwitterWidgetTest_004_areLoadedOnFirstVisitDirectlyFromUrl() {
    WidgetPageObject widget = new TwitterWidgetPageObject().createMultiple(
        TWITTER_MULTIPLE_WIDGETS_ARTICLE_NAME);
  ...
  public void MercuryTwitterWidgetTest_005_isErrorPresent() {
    WidgetPageObject widget = new TwitterWidgetPageObject().createIncorrect(
        TWITTER_INCORRECT_WIDGET_ARTICLE_NAME);
