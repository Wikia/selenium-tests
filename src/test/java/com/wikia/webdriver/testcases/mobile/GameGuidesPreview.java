 ...
 * @author PMG <p/> Below test cases are executed against Special:GameGuidesPreview 1. Verify that
 *         sections are opened in article view 2. Verify that hide button in section works 3. Verify
 *         that next image button in modal works 4. Verify that previous image button in modal works
