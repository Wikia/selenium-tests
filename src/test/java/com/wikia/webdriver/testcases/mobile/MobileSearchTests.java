 ...
 *         CHROMEMOBILE browser 1. Verify that user is able to see suggestions 2. Verify that when
 *         user click on + on suggestions text is copied to search field 3. Verify that when user go
 *         to Search page when he press search button 4. Verify that search results page looks
