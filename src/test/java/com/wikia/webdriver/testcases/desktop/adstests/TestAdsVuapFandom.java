...
//  public void adsVideoClosedAfterPlayingFandom(String pageType, String pageName, AdSlot slot) {
//    AdsFandomObject fandomPage = loadPage(pageName, pageType);
//    AutoplayVuap videoFanTakeover = prepareSlot(slot, fandomPage);
//
...
//  public void adsImageClickedOpensNewPageFandom(String pageType, String pageName, AdSlot slot) {
//    AdsFandomObject page = loadPage(pageName, pageType);
//    AutoplayVuap videoFanTakeover = prepareSlot(slot, page);
//
...
//      String pageType, String pageName, AdSlot slot
//  ) {
//    AdsFandomObject fandomPage = loadPage(pageName, pageType);
//    AutoplayVuap videoFanTakeover = prepareSlot(slot, fandomPage);
//
...
//  public void adsVuapCheckSlotSizesFandom(String pageType, String pageName, AdSlot slot) {
//    AdsFandomObject fandomPage = loadPage(pageName, pageType);
//    AutoplayVuap videoFanTakeover = prepareSlot(slot, fandomPage);
//
...
//  public void adsVuapTimeProgressingFandom(String pageType, String pageName, AdSlot slot)
//      throws InterruptedException {
//    AdsFandomObject fandomPage = loadPage(pageName, pageType);
//    AutoplayVuap vuap = prepareSlot(slot, fandomPage);
//
...
//  public void adsVuapVideoPausesFandom(String pageType, String pageName, AdSlot slot)
//      throws InterruptedException {
//    AdsFandomObject fandomPage = loadPage(pageName, pageType);
//    AutoplayVuap videoFanTakeover = prepareSlot(slot, fandomPage);
//
...
//  ) {
//    AdsFandomObject fandomPage = loadPage(pageName, pageType);
//    AutoplayVuap videoFanTakeover = prepareSlot(slot, fandomPage, true);
//    videoFanTakeover.waitForAdToLoad();
...
//  ) {
//    AdsFandomObject fandomPage = loadPage(pageName, pageType);
//    AutoplayVuap vuap = prepareSlot(slot, fandomPage, true);
...
////  public void adsVuapTimeProgressingFandomMobile(String pageType, String pageName, AdSlot slot)
////      throws InterruptedException {
...
////  }
////
////  private AutoplayVuap prepareSlot(AdSlot slot, AdsFandomObject fandomPage) {
////    return prepareSlot(slot, fandomPage, false);
////  }
////
////  private AutoplayVuap prepareSlot(AdSlot slot, AdsFandomObject fandomPage, Boolean isMobile) {
////    fandomPage.triggerOnScrollSlots();
////    AutoplayVuap videoFanTakeover = new AutoplayVuap(driver,
////                                                     slot,
////                                                     fandomPage.getIframeSelector(slot.getId()),
////                                                     isMobile
////    );
////    fandomPage.scrollTo(AdsFandomContent.getSlotSelector(slot));
