package com.wikia.webdriver.testcases.desktop.notificationstests.messagewallnotifications;

import com.wikia.webdriver.common.contentpatterns.PageContent;
import com.wikia.webdriver.common.core.configuration.Configuration;
import com.wikia.webdriver.common.properties.Credentials;
import com.wikia.webdriver.common.templates.NewTestTemplate;
import com.wikia.webdriver.elements.communities.desktop.components.navigation.global.MessagesNotifications;
...
public class MessageWallNotificationsFollowersMessageTests extends NewTestTemplate {
  ...
  public void followerNotificationNewMessage_setup_1() {
    ...
    base.loginAs(credentials.userName5, wikiURL);
  ...
  public void followerNotificationNewMessage_setup_2() {
    WikiBasePageObject base = new WikiBasePageObject();
    base.loginAs(credentials.userName6, wikiURL);
    MessageWall wall = new MessageWall().open(credentials.userName6);
