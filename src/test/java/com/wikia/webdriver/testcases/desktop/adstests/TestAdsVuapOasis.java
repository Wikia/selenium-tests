...
//  @Test(groups = {
//      "AdsVuapDefaultState"}, dataProviderClass = AdsDataProvider.class, dataProvider = "adsVuapDesktop")
//  public void vuapDefaultStateArea2ShouldRedirectToCorrectURL(Page page, AdSlot slot) {
...
//  @Test(groups = {
//      "AdsVuapDefaultState"}, dataProviderClass = AdsDataProvider.class, dataProvider = "adsVuapDesktop")
//  public void vuapDefaultStateArea4ShouldRedirectToCorrectURL(Page page, AdSlot slot) {
//    AdsBaseObject ads = openPageWithVideoInLocalStorage(page);
//    final AutoplayVuap vuap = new AutoplayVuap(driver,
//                                               slot,
//                                               ads.findFirstIframeWithAd(slot.getId()),
...
//  @Test(groups = {
//      "AdsVuapDefaultState"}, dataProviderClass = AdsDataProvider.class, dataProvider = "adsVuapDesktop")
//  public void vuapDefaultStateAutoplayIsMutedAfterReplayIsNotMuted(Page page, AdSlot slot)
//      throws InterruptedException {
//    AdsBaseObject ads = openPageWithVideoInLocalStorage(page, VuapVideos.VIDEO_10s);
//    final AutoplayVuap vuap = new AutoplayVuap(driver,
//                                               slot,
...
//  public void vuapResolvedStateAppearsOnSecondPageView(Page page, AdSlot slot)
//      throws InterruptedException {
//    AdsBaseObject ads = new AdsBaseObject(driver, page.getUrl(), WindowSize.DESKTOP);
//    final AutoplayVuap vuap = new AutoplayVuap(driver,
//                                               slot,
...
//  public void vuapResolvedStateShouldStartPlayingAfterClickOnReplay(Page page, AdSlot slot) {
...
//  public void vuapResolvedStateShouldProgressInTime(Page page, AdSlot slot)
//      throws InterruptedException {
//    AdsBaseObject ads = new AdsBaseObject(page.getUrl());
//    final AutoplayVuap vuap = new AutoplayVuap(driver,
//                                               slot,
...
//  @Test(groups = {
//      "AdsVuapResolvedState"}, dataProviderClass = AdsDataProvider.class, dataProvider = "adsVuapResolvedState")
//  public void vuapResolvedStateShouldRedirectToCorrectURL(Page page, AdSlot slot) {
//    AdsBaseObject ads = new AdsBaseObject(page.getUrl());
//    AutoplayVuap vuap = new AutoplayVuap(driver, slot, ads.findFirstIframeWithAd(slot.getId()), false);
//    ads.scrollToSlot(slot.getId());
//    vuap.replay();
...
//  @Test(groups = {
//      "AdsVuapResolvedState"}, dataProviderClass = AdsDataProvider.class, dataProvider = "adsVuapResolvedState")
//  public void vuapResolvedStateShouldHaveLinkToFandomArticleOnImage(Page page, AdSlot slot) {
...
//  public void vuapResolvedStateShouldCloseAfterTapingOnCloseButton(Page page, AdSlot slot) {
...
//  @Test(groups = {
//      "AdsVuapResolvedState"}, dataProviderClass = AdsDataProvider.class, dataProvider = "adsVuapResolvedState")
//  public void vuapResolvedStateIsNotMuted(Page page, AdSlot slot) throws InterruptedException {
//    AdsBaseObject ads = new AdsBaseObject(page.getUrl());
//    final AutoplayVuap vuap = new AutoplayVuap(driver,
//                                               slot,
//                                               ads.findFirstIframeWithAd(slot.getId()),
...
//  @Test(groups = {
//      "AdsVuapResolvedState"}, dataProviderClass = AdsDataProvider.class, dataProvider = "adsVuapResolvedState")
//  public void vuapResolvedShouldEnd(Page page, AdSlot slot) {
//    final AdsBaseObject ads = openPageWithVideoInLocalStorage(page);
//    final AutoplayVuap vuap = new AutoplayVuap(driver,
//                                               slot,
//                                               ads.findFirstIframeWithAd(slot.getId()),
...
//  public void vuapCheckSlotSizesOasis(Page page, AdSlot slot) {
//    final AdsBaseObject ads = openPageWithVideoInLocalStorage(page);
//    final AutoplayVuap vuap = new AutoplayVuap(driver,
//                                               slot,
//                                               ads.findFirstIframeWithAd(slot.getId()),
