...
import com.wikia.webdriver.elements.communities.mobile.pages.discussions.ReportedPostsAndRepliesPage;
...
public class ReportingPostTests extends NewTestTemplate {
  ...
  private void moderatorCanApproveReportedPostOnPostDetailsPage() {
    ...
    Assertion.assertFalse(clickApproveOnValidatePostModalDialog(page, postEntity),
  ...
  private void moderatorCanSeeReReportedPostOnReportedPostsPage() {
    ...
    final PostEntity post = open.getPost().findPostById(data.getFirstPostId());
