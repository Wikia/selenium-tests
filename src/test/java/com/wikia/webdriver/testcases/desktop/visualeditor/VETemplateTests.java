...
public class VETemplateTests extends NewTestTemplate {
  ...
  @RelatedIssue(issueID = "WW-108")
  @Test(enabled = false, groups = {"VETemplate", "VETemplateTests_004", "VEAddTemplate",
                                   "VETemplateTests_005", "VETemplateTests_006"})
  ...
  @RelatedIssue(issueID = "WW-108")
  @Test(enabled = false, groups = {"VETemplate", "VETemplateTests_005",
                                   "VEDeleteTemplate"}, dependsOnGroups = "VETemplateTests_004")
  ...
  @RelatedIssue(issueID = "WW-108")
  @Test(enabled = false, groups = {"VETemplate", "VETemplateTests_006",
                                   "VEAddTemplate"}, dependsOnGroups = "VETemplateTests_004")
