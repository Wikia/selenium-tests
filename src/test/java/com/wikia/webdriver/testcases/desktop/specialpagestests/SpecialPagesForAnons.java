package com.wikia.webdriver.testcases.desktop.specialpagestests;
...
public class SpecialPagesForAnons extends NewTestTemplate {
  ...
  @Test(dataProviderClass = SpecialPagesDataProvider.class, dataProvider = "getSpecialPagesForAnons", groups = {
      "SpecialPagesForAnons_001", "SpecialPages"})
  public void SpecialPagesForAnons_001_verifyHeaders(
      String specialPageName, String specialPageHeader
  ) {
