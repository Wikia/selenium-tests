 ...
 *         wgForceVisualEditor = false User Editor Preference is set to Default for Anon VE-983
 *         verify VE Editor is loaded when clicking Add Page from the contribution drop down VE-983
 *         verify VE Editor is loaded when clicking the main edit button on the top of the article
 *         VE-983 verify VE Editor is loaded when clicking the red link in the article VE-983 verify
 *         VE Editor is loaded when clicking the section edit link in the article VE-983 verify VE
 *         Editor is loaded when using ?veaction=edit in the URL VE-983 verify VE Editor is loaded
 *         on List namespace VE-983 verify CK Editor is loaded on Category namespace VE-983 verify
 *         Src Editor is loaded on Template namespace VE-983 verify CK Editor is loaded when using
 *         ?action=edit in the URL
 */
...
public class VEEnabledEditorEntryAnonTests extends NewTestTemplate {
  ...
  @Test(groups = {"VEEnabledEditorEntryAnonTests", "VEEnabledEditorEntryAnonTests_001",
      "createPageEntry"})
  ...
  @Test(groups = {"VEEnabledEditorEntryAnonTests", "VEEnabledEditorEntryAnonTests_002",
      "articleEditEntry"})
  ...
  @Test(groups = {"VEEnabledEditorEntryAnonTests", "VEEnabledEditorEntryAnonTests_003",
      "redlinkEntry"})
  ...
  @Test(groups = {"VEEnabledEditorEntryAnonTests", "VEEnabledEditorEntryAnonTests_004",
      "sectionEditEntry"})
  ...
  @Test(groups = {"VEEnabledEditorEntryAnonTests", "VEEnabledEditorEntryAnonTests_005",
      "veactionURLEntry"})
  ...
  @Test(groups = {"VEEnabledEditorEntryAnonTests", "VEEnabledEditorEntryAnonTests_007",
      "categoryEntry"})
  ...
  @Test(groups = {"VEEnabledEditorEntryAnonTests", "VEEnabledEditorEntryAnonTests_008",
      "templateEntry"})
  ...
  @Test(groups = {"VEEnabledEditorEntryAnonTests", "VEEnabledEditorEntryAnonTests_009",
      "actionURLEntry"})
