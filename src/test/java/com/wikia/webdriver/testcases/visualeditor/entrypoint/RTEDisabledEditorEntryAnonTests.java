 ...
 *         <p/>
 *         Editor Entry Point Test on wiki that has wgEnabledRTEExt = false, wgVisualEditorUI =
 *         true, wgForceVisualEditor = true User Editor Preference is set to Default for Anon VE-983
