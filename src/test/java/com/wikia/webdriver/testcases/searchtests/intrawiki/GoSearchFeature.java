...
/*
 * AnonFromSuggestion: Make sure clicking enter on suggestion takes you to destination page for
 * anonymous UserFromSuggestion: Make sure clicking enter on suggestion takes you to destination
 * page for logged in user goSearchPreference: Make sure clicking search button after typing article
 * name to the search field takes you to destination page when user has the preference enabled
 */
...
public class GoSearchFeature extends IntraWiki {
  ...
  @RelatedIssue(issueID = "MAIN-5045", comment = "please Type 'GON' in search, arrow down to "
      + "Gonzo article and enter. If you got to " + "Gonzo article the test passed.")
