...
public class TestATF extends TemplateNoFirstLoad {
  ...
  @Test(dataProviderClass = AdsDataProvider.class, dataProvider = "delayBtf", groups = {"TestATF",
      "Ads"})
  ...
  @Test(dataProviderClass = AdsDataProvider.class, dataProvider = "disableBtf", groups = {
      "TestATF", "Ads"})
  public void TestATFDisableBTF(String wikiName, String article, boolean isWgVarOn) {
    ...
    Assertion.assertNotEquals(adsBaseObject.checkSlotOnPageLoaded(AdsContent.PREFOOTER_LEFT),
        isWgVarOn);
    Assertion.assertNotEquals(adsBaseObject.checkSlotOnPageLoaded(AdsContent.PREFOOTER_RIGHT),
        isWgVarOn);
    Assertion.assertNotEquals(adsBaseObject.checkSlotOnPageLoaded(AdsContent.LEFT_SKYSCRAPPER_2),
        isWgVarOn);
    Assertion.assertNotEquals(adsBaseObject.checkSlotOnPageLoaded(AdsContent.FLOATING_MEDREC),
        isWgVarOn);
  }
