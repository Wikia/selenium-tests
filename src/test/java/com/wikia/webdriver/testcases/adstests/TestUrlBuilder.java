...
public class TestUrlBuilder {
  ...
  private static Object[][] TEST_DATA = new Object[][]{
      ...
      {"yugioh", "wiki/Main_Page", false, false, "http://yugioh.wikia.com/wiki/Main_Page",
      ...
      {"naruto", "wiki/Narutopedia", false, false, "http://naruto.wikia.com/wiki/Narutopedia",
      ...
      {"wowwiki", "wiki/Portal:Main", true, false, "https://wowwiki.wikia.com/wiki/Portal:Main",
      ...
      {"leagueoflegends", "wiki/League_of_Legends_Wiki", false, true,
       ...
       "http://leagueoflegends.dmytror.wikia-dev.pl/wiki/League_of_Legends_Wiki",
       "http://leagueoflegends.wikia-staging.com/wiki/League_of_Legends_Wiki"},
      {"wowwiki", "wiki/Portal:Main", true, true, "https://wowwiki.wikia.com/wiki/Portal:Main",
       "https://wowwiki.preview.wikia.com/wiki/Portal:Main",
       "https://wowwiki.sandbox.wikia.com/wiki/Portal:Main",
       "https://wowwiki.sandbox-mercurydev.wikia.com/wiki/Portal:Main",
       "https://wowwiki.dmytror.wikia-dev.pl/wiki/Portal:Main",
  ...
  private static Object[][] TEST_DATA_LANGUAGE = new Object[][]{
      {"drama", "wiki/Portada", false, false, "http://es.drama.wikia.com/wiki/Portada",
       ...
       "http://es.drama.wikia-staging.com/wiki/Portada", "es"},
      {"marvel-filme", "wiki/Marvel-Filme", false, false,
       ...
       "http://de.marvel-filme.wikia-staging.com/wiki/Marvel-Filme", "de"},
      {"pad", "wiki/Puzzle_%26_Dragons_%E7%BB%B4%E5%9F%BA", false, false,
       ...
       "http://zh.pad.wikia-staging.com/wiki/Puzzle_%26_Dragons_%E7%BB%B4%E5%9F%BA", "zh"},
      {"drama", "wiki/Portada", false, true, "http://drama.wikia.com/es/wiki/Portada",
       ...
       "http://drama.wikia-staging.com/es/wiki/Portada", "es"},
      {"marvel-filme", "wiki/Marvel-Filme", false, true,
       ...
       "http://marvel-filme.wikia-staging.com/de/wiki/Marvel-Filme", "de"},
      {"squadraspecialecobra11", "wiki/Squadra_speciale_Cobra_11", false, true,
       ...
       "http://squadraspecialecobra11.wikia-staging.com/it/wiki/Squadra_speciale_Cobra_11", "it"},
      {"onepiece", "wiki/One_Piece_Wiki_Italia", false, true,
       ...
       "http://onepiece.wikia-staging.com/it/wiki/One_Piece_Wiki_Italia", "it"},
      {"pad", "wiki/Puzzle_%26_Dragons_%E7%BB%B4%E5%9F%BA", false, true,
       ...
       "http://pad.wikia-staging.com/zh/wiki/Puzzle_%26_Dragons_%E7%BB%B4%E5%9F%BA", "zh"},
      {"gundam", "wiki/%E3%82%AC%E3%83%B3%E3%83%80%E3%83%9A%E3%83%87%E3%82%A3%E3%82%A2", false,
       ...
       "ja"},
      {"naruto", "wiki/Narutopedia", false, true, "http://naruto.wikia.com/de/wiki/Narutopedia",
       ...
       "http://naruto.wikia-staging.com/de/wiki/Narutopedia", "de"},
      {"gameofthrones", "wiki/Staffel_4", false, true,
       ...
       "http://gameofthrones.wikia-staging.com/de/wiki/Staffel_4", "de"},
      {"gta", "wiki/Fahrzeuge_(V)", false, true, "http://gta.wikia.com/de/wiki/Fahrzeuge_(V)",
       ...
       "http://gta.wikia-staging.com/de/wiki/Fahrzeuge_(V)", "de"},
      {"fahrrad", "wiki/Reifenumfang_%28Tabelle%29", false, true,
       ...
       "http://fahrrad.wikia-staging.com/de/wiki/Reifenumfang_%28Tabelle%29", "de"},
      {"bindingofisaac", "wiki/Items", false, true, "http://bindingofisaac.wikia.com/de/wiki/Items",
       ...
       "http://bindingofisaac.wikia-staging.com/de/wiki/Items", "de"},
      {"videospielehub", "wiki/Videospiele_Hub", false, true,
       ...
       "http://videospielehub.wikia-staging.com/de/wiki/Videospiele_Hub", "de"},
      {"jedipedia", "wiki/Jedipedia:Hauptseite", false, true,
       ...
       "http://jedipedia.wikia-staging.com/de/wiki/Jedipedia:Hauptseite", "de"},
      {"memory-alpha", "wiki/Portal:Main", false, true,
       ...
       "http://memory-alpha.wikia-staging.com/wiki/Portal:Main", "en"},
      {"memory-alpha", "wiki/Hauptseite", false, true,
       ...
       "http://memory-alpha.wikia-staging.com/de/wiki/Hauptseite", "de"},};
  ...
  public void urlBuilderTests() throws Exception {
    ...
    for (Object[] data : TEST_DATA) {
      ...
      Assert.assertEquals(c.newInstance((String) data[0],
                              ...
                              .getUrlForPath((String) data[1]), (String) data[5]);
      Assert.assertEquals(c.newInstance((String) data[0],
                                        "sandbox",
                                        (Boolean) data[2],
                                        (Boolean) data[3],
                              ...
                              .getUrlForPath((String) data[1]), (String) data[6]);
      Assert.assertEquals(c.newInstance((String) data[0],
                                        "sandbox-mercurydev",
                                        (Boolean) data[2],
                                        (Boolean) data[3],
                                        DEFAULT_LANGUAGE
      ).getUrlForPath((String) data[1]), (String) data[7]);
      Assert.assertEquals(c.newInstance((String) data[0],
                                        "dev-dmytror",
                                        (Boolean) data[2],
                                        (Boolean) data[3],
      ...
      Assert.assertEquals(c.newInstance((String) data[0],
                              ...
                              .getUrlForPath((String) data[1]), (String) data[9]);
    }
  }
  ...
  public void getWikiaUrlTests() throws Exception {
    ...
    Assert.assertEquals(
        c.newInstance("mediawiki119", "preview", false, false, DEFAULT_LANGUAGE).getWikiGlobalURL(),
        "http://www.preview.wikia.com"
    );
    Assert.assertEquals(c.newInstance("mediawiki119", "sandbox-s1", false, false, DEFAULT_LANGUAGE)
                            .getWikiGlobalURL(), "http://www.sandbox-s1.wikia.com");
    Assert.assertEquals(
        c.newInstance("mediawiki119", "prod", false, false, DEFAULT_LANGUAGE).getWikiGlobalURL(),
        "http://www.wikia.com"
    );
  }

  private Constructor<UrlBuilder> getUrlBuilderConstructor() throws NoSuchMethodException {
    Constructor<UrlBuilder> c = UrlBuilder.class.getDeclaredConstructor(String.class,
                                                                        String.class,
                                                                        Boolean.class,
                                                                        Boolean.class,
                                                                        String.class
  ...
  public void getUrlForPathTests() throws Exception {
    ...
    Assert.assertEquals(
        c.newInstance("mediawiki119", "preview", false, false, DEFAULT_LANGUAGE)
  ...
  public void getUrlForPathWithLanguageTests() throws Exception {
    ...
    Assert.assertEquals(
        c.newInstance("mediawiki119", "preview", false, true, "szl")
            .getUrlForPath("/wiki/Special:Version"),
        "http://mediawiki119.preview.wikia.com/szl/wiki/Special:Version"
    );

    Assert.assertEquals(
        c.newInstance("mediawiki119", "preview", false, false, "szl")
            .getUrlForPath("/wiki/Special:Version"),
  ...
  public void getUrlWithWWW() throws Exception {
    ...
    Assert.assertEquals(
        urlBuilder.getUrlForWikiPageWithWWW(MercurySubpages.MAIN_PAGE),
