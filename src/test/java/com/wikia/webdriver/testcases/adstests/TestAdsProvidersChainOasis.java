...
public class TestAdsProvidersChainOasis extends TemplateNoFirstLoad {
  ...
  public void adsProvidersChainOasis(String wikiName, String article, String slotName,
      String providers, int times) {
    new AdsBaseObject(driver, urlBuilder.getUrlForPath(wikiName, article), BROWSER_DIMENSION)
        .refresh(times).verifyProvidersChain(slotName, providers);
  }
}
