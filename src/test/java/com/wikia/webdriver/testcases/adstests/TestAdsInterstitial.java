...
public class TestAdsInterstitial extends TemplateNoFirstLoad {
  ...
  @Test(dataProviderClass = AdsDataProvider.class, groups = "TestInterstitialOasis",
      dataProvider = "interstitialOasis")
  public void adsInterstitialAdScaledOasis(String wikiName, String article, Dimension pageSize,
      Dimension adSize, boolean shouldAdBeScaled) {
    testInterstitial(wikiName, article, pageSize, adSize, shouldAdBeScaled);
  }

  @Test(dataProviderClass = AdsDataProvider.class, groups = "TestInterstitialMercury",
      dataProvider = "interstitialMercury")
  public void adsInterstitialAdScaledMercury(String wikiName, String article, Dimension pageSize,
      Dimension adSize, boolean shouldAdBeScaled) {
    testInterstitial(wikiName, article, pageSize, adSize, shouldAdBeScaled);
  }

  private void testInterstitial(String wikiName, String article, Dimension pageSize,
      Dimension adSize, boolean shouldAdBeScaled) {
