...
public class TestAdsGptPageParamOasis extends TemplateNoFirstLoad {
  ...
  @Test(dataProviderClass = AdsDataProvider.class, dataProvider = "adsGptPageParamOasis",
      groups = "AdsGptPageParamOasis")
  @UseUnstablePageLoadStrategy
  public void adsGptPageParamOasis(String wikiName, String article, String gptPattern,
