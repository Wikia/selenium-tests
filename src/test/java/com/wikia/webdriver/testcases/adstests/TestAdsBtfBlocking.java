...
public class TestAdsBtfBlocking extends NewTestTemplate {
  ...
  public void adsAtfDisableBtfExceptHighlyViewableSlotsOasis(String wikiName, String article,
    ...
    Assertion.assertTrue(adsBaseObject.checkSlotOnPageLoaded(AdsContent.MEDREC), "TOP_RIGHT_BOXAD not loaded");
    Assertion.assertTrue(adsBaseObject.checkSlotOnPageLoaded(AdsContent.TOP_LB), "TOP_LEADERBOARD not loaded");
    Assertion.assertTrue(adsBaseObject.checkSlotOnPageLoaded(AdsContent.INVISIBLE_SKIN), "INVISIBLE_SKIN not loaded");
    Assertion.assertTrue(adsBaseObject.checkSlotOnPageLoaded(AdsContent.INVISIBLE_HIGH_IMPACT_2), "INVISIBSE_HIGH_IMPACT_2 not loaded");
    Assertion.assertTrue(adsBaseObject.checkSlotOnPageLoaded(AdsContent.INCONTENT_LEADERBOARD), "INCONTENT_LEADERBOARD not loaded");
    Assertion.assertTrue(adsBaseObject.checkSlotOnPageLoaded(AdsContent.FLOATING_MEDREC), "FLOATING_MEDREC not loaded");
