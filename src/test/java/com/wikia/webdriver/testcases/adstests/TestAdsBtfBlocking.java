...
public class TestAdsBtfBlocking extends TemplateNoFirstLoad {
  ...
  private static final Page PAGE_DISABLE_BTF_HIVI = new Page(
      "project43",
  ...
  public void adsAtfDelayBtfOasis() {
    ...
    Assertion.assertTrue(
        adsBaseObject.checkSlotOnPageLoaded(AdsContent.INVISIBLE_SKIN),
        AdsContent.INVISIBLE_SKIN
    );
    Assertion.assertTrue(
        adsBaseObject.checkSlotOnPageLoaded(AdsContent.BOTTOM_LB),
  ...
  public void adsAtfDisableBtfOasis() {
    ...
    Assertion.assertTrue(
        adsBaseObject.checkSlotOnPageLoaded(AdsContent.MEDREC),
        "Slot" + AdsContent.MEDREC
    );
    Assertion.assertTrue(
        adsBaseObject.checkSlotOnPageLoaded(AdsContent.TOP_LB),
    ...
    Assertion.assertFalse(
        adsBaseObject.checkSlotOnPageLoaded(AdsContent.INVISIBLE_HIGH_IMPACT_2),
  ...
  public void adsAtfDelayBtfMercury() {
    ...
    Assertion.assertTrue(
        adsBaseObject.checkSlotOnPageLoaded(AdsContent.MOBILE_BOTTOM_LB),
