...
public class TestAdsExtraMarkerOasis extends TemplateNoFirstLoad {
  ...
  @Test(dataProviderClass = AdsDataProvider.class, groups = "AdsExtraMarkerOasis",
      dataProvider = "adsExtraMarkerOasis")
  public void AdsExtraMarkerOasis(final String wikiName, final String article, final String adType,
    ...
    new WebDriverWait(driver, TIMEOUT_SEC).until(new ExpectedCondition<Boolean>() {
      ...
      public String toString() {
        return String.format("Expected message: [ %s ], Logs: [ %s ]", message, wikiPage
            .getBrowserLogs(adType).toString());
      }
    });
  }
}
