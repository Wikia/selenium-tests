...
public class NotificationsComponentObject extends BasePageObject{
	...
	public String getNotificationLink(int notificationNumber) {
		...
		PageObjectLogging.log("getNotificationLink", "get addres that of "+notificationNumber+" notification points to", true, driver);
	...
	public String getNotificationLink(String text) {
		for (int i = 0; i < notificationsList.size(); i++) {
			if (notificationsList.get(i).findElement(By.cssSelector(".msg-body")).getText().contains(text)) {
				PageObjectLogging.log("getNotificationLink", "get addres that of "+i+1+" notification points to", true, driver);
				return notificationsList.get(i).getAttribute("href");
			}
		}
		PageObjectLogging.log("getNotificationLink", "No notification that contains the following text: "+text, false, driver);
		return null;
	}
