...
public class SourceEditModePageObject extends EditMode{
	...
	public void checkSourceVideoContent(String desiredContent) {
		Assertion.assertEquals(desiredContent.substring(1, 38) + desiredContent.substring(48), getSourceContent()
			.substring(1, 38) + getSourceContent().substring(48));
	}
	...
	public void verifyVideoWidth(int widthDesired) {
		...
		int width = Integer.parseInt(content.substring(content.indexOf("px") - 4, content.indexOf("px") - 1));
		Assertion.assertNumber(width, widthDesired, "width is " + width + " should be " + widthDesired);
	}
