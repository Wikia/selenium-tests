...
public class ChatPageObject extends BasePageObject {
	...
	private By userContextMenu = By.cssSelector("ul.regular-actions li");
	private By adminContextMenu = By.cssSelector("ul.admin-actions li");
	private By privateMessageHeader = By.cssSelector("#Rail h1.private");
	private By privateChatHeader = By.cssSelector("#ChatHeader h1.private");
