...
//		Global.DOMAIN = "http://sandbox-qa05.mediawiki119.wikia.com/";
		...
		Global.CONFIG_FILE = new File("/Users/garth/eng"+File.separator+"selenium-config"+File.separator+"config.xml");
		Global.CAPTCHA_FILE = new File("/Users/garth/eng"+File.separator+"selenium-config"+File.separator+"captcha.txt");
